...
const canvas = document.querySelector('.bathroom4');
...
camera.position.set(-340, 0, 0);
camera.lookAt(0, 0, 0);
scene.add(camera);

const camera1 = new THREE.PerspectiveCamera(fov, aspect, near, far);
camera1.position.set(-340, 0, 0);
...
light3.position.set(-750, 120, -150);
...
// var light15 = new THREE.SpotLight(0xffffff, 1.5);
...
// var light9 = new THREE.SpotLight(0xffffff, 0.8);
...
// const defaultMaterial1 = new THREE.MeshBasicMaterial({ map: defaultTexture1, side: THREE.BackSide, color: new THREE.Color(0.8, 0.8, 0.8)  });
const defaultMaterial22 = new THREE.MeshBasicMaterial({ map: defaultTexture22, side: THREE.BackSide, color: new THREE.Color(0.8, 0.8, 0.8)  });
// const defaultMaterial3 = new THREE.MeshBasicMaterial({ map: defaultTexture3, side: THREE.BackSide, color: new THREE.Color(0.8, 0.8, 0.8)  });
...
//   const cubeGeometry = new THREE.BoxGeometry(860, 350, 1200);
...
console.log(texture.id);
  ...
  const cubeGeometry = new THREE.BoxGeometry(700, 540, 1210);
...
const cubeGeometry2 = new THREE.BoxGeometry(699, 539, 1209);
...
// let circleMat = new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load('./bathroom/annie-spratt-x-cEGE4dw8Q-unsplash.jpg')})
// let circle = new THREE.Mesh(circleGeo, circleMat);
// circle.position.set(0, 0, 650);
// circle.rotation.y = Math.PI / 1;
// scene.add(circle);


let circleGeo4 = new THREE.CircleGeometry(100);
...
circle4.position.set(20, 150, 582);
// circle4.scale.setX(1);
circle4.rotation.y = Math.PI / 1;
scene.add(circle4);

const reflectorGeometry = new THREE.CircleGeometry(95);
...
reflector.rotation.y = Math.PI / 1;
reflector.position.set(20, 150, 580);
...
// });
// reflector1.rotation.y = Math.PI / -2; // 90 degrees in radians

// reflector1.position.set(345, -20, -155);
...
// gltfloader.load('./bathroom/modern_bathroom.glb', function (gltf2) {

//   const model2 = gltf2.scene;

//   model2.rotation.y = Math.PI / 1;
//   model2.scale.set(300, 300, 300);
//   model2.position.set(0, -400, 0);
...
gltfloader.load('./bathroom/bathroom (2).glb', function (gltf2) {

  const model2 = gltf2.scene;

  model2.rotation.y = Math.PI / 1;
  model2.scale.set(60, 60, 60);
  model2.position.set(340, -160, -300);
...
//   model10.position.set(570, -230, -500);
...
//   model4.position.set(-720, -80, -410);
//   // scene1.add(gltf4.scene.clone());
//   scene1.add(model4);
...
//   model1.scale.set(2100, 600, 2200);
//   model1.position.set(50, -370, -510);
...
//   model4.position.set(190, 60, 200);
...
//   model8.position.set(110, -250, -480);
...
//   model6.position.set(-200, -280, -470);
//   scene1.add(model6);
...
//   model15.scale.set(700, 560, 500);
//   model15.position.set(1190, 220, -450);
//   scene1.add(model15);
...
//   model16.scale.set(250, 250, 250);
//   model16.position.set(-428, -390, 260);
