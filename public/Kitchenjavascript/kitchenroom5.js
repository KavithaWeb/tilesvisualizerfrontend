...
import { kitchen, kitchen4, bathroom2, kitchenplane } from '../Mainjavascript/constants.js';
import { request } from '../services/api.service.js';
const canvas = document.querySelector('.kitchen5');
...
let max = controls.maxDistance = 500;
...
const light2 = new THREE.SpotLight(0xffffff,0.8);
 light2.position.set(1300, 220, 0);
...
const light3 = new THREE.SpotLight(0xffffff,0.8);
...
// var light8 = new THREE.SpotLight(0xffffff, 0.6);
// light8.position.set(160, 0,40);
// light8.target.position.set(0, 0, -240);
...
// images2 = document.getElementsByClassName("img2");

// for (const img2 of images2) {

//   imageload2.push(loader.load(`${img2.src}?not-from-cache-please`));
...
//   const cubeGeometry = new THREE.BoxGeometry(1735, 590, 1250);
...
// const cubeGeometry3 = new THREE.BoxGeometry(1734, 589, 1249);
...
let repeatY = 9; // Default Y repeat value
...
function TilesChanger(obj = {}) {
  ...
  const cubeGeometry = new THREE.BoxGeometry(1150, 750, 1050);
...
const cubeGeometry3 = new THREE.BoxGeometry(1149, 749, 1049);
...
// var geometry1 = new THREE.PlaneGeometry(360, 240);

// // create a texture loader
// var textureLoader1 = new THREE.TextureLoader();

// // load the texture
// textureLoader1.load('./kitchen/istockphoto-170094585-170667a.jpg', function(texturei1) {
//   // create a material with the texture
//   var materiali1 = new THREE.MeshBasicMaterial({ map: texturei1, color: new THREE.Color(0.8, 0.8, 0.8)});

//   // create the mesh using the geometry and material
//   var mesh1 = new THREE.Mesh(geometry1, materiali1);
//   mesh1.position.set(200 ,-50 ,-520);
...
// var geometry2 = new THREE.PlaneGeometry(520, 500);

// // create a texture loader
// var textureLoader2 = new THREE.TextureLoader();

// // load the texture
// textureLoader2.load('./kitchen/Screenshot 2023-08-04 124624.png', function(texturei2) {
//   // create a material with the texture
//   var materiali2 = new THREE.MeshBasicMaterial({ map: texturei2, color: new THREE.Color(0.8, 0.8, 0.8)});

//   // create the mesh using the geometry and material
//   var mesh2 = new THREE.Mesh(geometry2, materiali2);
//   mesh2.position.set(-740 ,-120 ,0);
...
// let front4 = kitchen4.front4;
// let right4 = kitchen4.right4;


// var defaultTexture222 = loader.load(`${'https://jabez-tiles.s3.ap-south-1.amazonaws.com/PW03686_b.jpg'}?not-from-cache-please`);
// // var defaultTexture3 = loader.load(`${'https://jabez-tiles.s3.ap-south-1.amazonaws.com/PW03575_b.jpg'}?not-from-cache-please`);
...
// // Create default materials using the default textures
// // const defaultMaterial1 = new THREE.MeshStandardMaterial({ map: defaultTexture1, side: THREE.BackSide, roughness: 0.76, metalness: 0.9 });
// const defaultMaterial222 = new THREE.MeshStandardMaterial({ map: defaultTexture222, side: THREE.BackSide, roughness: 0.76, metalness: 0.9 });
// // const defaultMaterial3 = new THREE.MeshStandardMaterial({ map: defaultTexture3, side: THREE.BackSide, roughness: 0.76, metalness: 0.9 });



// let skyBox4;
// function TilesChanger4(obj = {}) {

//   let materialside4 = []


//   materialside4.push(defaultMaterial222);
     

//   imageload2.forEach((texture1, ii) => {
 
//       texture1.wrapS = THREE.RepeatWrapping;
//       texture1.wrapT = THREE.RepeatWrapping;
//       texture1.repeat.set(1, 1);

//       const material4 = new THREE.MeshBasicMaterial({ map: texture1});
  
    
//       materialside4.push(material4);
//   });
    
//     const cubeGeometry4 = new THREE.PlaneGeometry(140, 50);
  
    
//     front4 = obj?.front4 || front4
//     right4 = front4
//     cubeGeometry4.clearGroups();
//     cubeGeometry4.addGroup(0, 6, front4);    // right

   
//     const groups = [
//       { start: 0, count: 6, materialIndex: front4 }

//     ];
    
//     cubeGeometry4.groups = groups;
    
//     if (!skyBox4) {
//       skyBox4 = new THREE.Mesh(cubeGeometry4, materialside4);
//       skyBox4.position.set(728 ,25 ,105);

//       skyBox4.rotation.y = Math.PI / -2;
//       skyBox4.castShadow = true;
//       skyBox4.receiveShadow = true;
//       scene.add(skyBox4);
//     }
    
//     else {
//       skyBox4.geometry = cubeGeometry4;
    
//       skyBox4.material = materialside4;
    
//     }



//     const skyBox6 = new THREE.Mesh(cubeGeometry4, materialside4);
  
//     skyBox6.position.set(728 ,25 ,520);

//   skyBox6.rotation.y = Math.PI / -2;
//     skyBox6.castShadow = true;
//     skyBox6.receiveShadow = true;
//     scene.add(skyBox6);

//     const skyBox7 = new THREE.Mesh(cubeGeometry4, materialside4);
  
//     skyBox7.position.set(728 ,25 ,-310);

//   skyBox7.rotation.y = Math.PI / -2;
//     skyBox7.castShadow = true;
//     skyBox7.receiveShadow = true;
//     scene.add(skyBox7);


//     const skyBox8 = new THREE.Mesh(cubeGeometry4, materialside4);
  
//     skyBox8.position.set(728 ,-65 ,-520);

//   skyBox8.rotation.y = Math.PI / -2;
//     skyBox8.castShadow = true;
//     skyBox8.receiveShadow = true;
//     scene.add(skyBox8);

//     const skyBox9 = new THREE.Mesh(cubeGeometry4, materialside4);
  
//     skyBox9.position.set(728 ,115 ,-102);

//   skyBox9.rotation.y = Math.PI / -2;
//     skyBox9.castShadow = true;
//     skyBox9.receiveShadow = true;
//     scene.add(skyBox9);

//     const skyBox10 = new THREE.Mesh(cubeGeometry4, materialside4);
  
//     skyBox10.position.set(728 ,115 ,310);

//   skyBox10.rotation.y = Math.PI / -2;
//     skyBox10.castShadow = true;
//     skyBox10.receiveShadow = true;
//     scene.add(skyBox10);

//     const skyBox11 = new THREE.Mesh(cubeGeometry4, materialside4);
  
//     skyBox11.position.set(728 ,115 ,-520);

//   skyBox11.rotation.y = Math.PI / -2;
//     skyBox11.castShadow = true;
//     skyBox11.receiveShadow = true;
//     scene.add(skyBox11);

//     const skyBox12 = new THREE.Mesh(cubeGeometry4, materialside4);
  
//     skyBox12.position.set(728 ,-65 ,-100);

//   skyBox12.rotation.y = Math.PI / -2;
//     skyBox12.castShadow = true;
//     skyBox12.receiveShadow = true;
//     scene.add(skyBox12);

//     const skyBox13 = new THREE.Mesh(cubeGeometry4, materialside4);
  
//     skyBox13.position.set(728 ,-65 ,310);

//   skyBox13.rotation.y = Math.PI / -2;
//     skyBox13.castShadow = true;
//     skyBox13.receiveShadow = true;
//     scene.add(skyBox13);

//     const skyBox14 = new THREE.Mesh(cubeGeometry4, materialside4);
  
//     skyBox14.position.set(105 ,-70 ,-620);

// //   skyBox14.rotation.y = Math.PI / -1;
//     skyBox14.castShadow = true;
//     skyBox14.receiveShadow = true;
   
//     scene.add(skyBox14);

//     const skyBox15 = new THREE.Mesh(cubeGeometry4, materialside4);
  
//     skyBox15.position.set(105 ,300 ,-620);

// //   skyBox15.rotation.y = Math.PI / -2;
//     skyBox15.castShadow = true;
//     skyBox15.receiveShadow = true;
//     scene.add(skyBox15);


//     const skyBox16 = new THREE.Mesh(cubeGeometry4, materialside4);
  
//     skyBox16.position.set(105 ,120 ,-620);

// //   skyBox16.rotation.y = Math.PI / -2;
//     skyBox16.castShadow = true;
//     skyBox16.receiveShadow = true;
//     scene.add(skyBox16);
// }
// TilesChanger4();
...
// gltfloader.load('./kitchen/window (2).glb', function (gltf6) {

//   const model6 = gltf6.scene;

//   model6.rotation.y = Math.PI / -2;
//   model6.scale.set(4, 4, 5);
//   model6.position.set(390, -80, -280);
//   scene1.add(model6);
...
gltfloader.load('./kitchen/simple_house_-_kitchen (1).glb', function (gltf6) {

    const model6 = gltf6.scene;
  
    model6.rotation.y = Math.PI / 2;
    model6.scale.set(240, 350, 240);
    model6.position.set(910, -498, 2208);
    scene1.add(model6);
    model6.traverse(function(child) {
      if (child.isMesh) {
        // child.castShadow = true;
...
// gltfloader.load('./kitchen/small_modern_kitchen.glb', function (gltf6) {

//     const model6 = gltf6.scene;
  
//     model6.rotation.y = Math.PI / -2;
//     model6.scale.set(200, 200, 200);
//     model6.position.set(-30, 113, 0);
//     scene1.add(model6);
//     model6.traverse(function(child) {
//       if (child.isMesh) {
//         // child.castShadow = true;
