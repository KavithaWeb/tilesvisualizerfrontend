...
import { kitchenplane, kitchen4} from '../Mainjavascript/constants.js';
...
let max = controls.maxDistance = 395;
...
function renderData(start) {
    ...
    const attachedData3 = { fileUrl: "https://jabez-tiles.s3.ap-south-1.amazonaws.com/joshua-bartell-6vvIBTvL90A-unsplash.jpg", id:"11", tiles: "tilesimages" };
...
var geometry5 = new THREE.PlaneGeometry(245, 400);
...
textureLoader5.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/Screenshot 2023-05-08 140207.png', function(texturei5) {
  ...
  mesh5.position.set(362 ,180 ,-620);
  // add the mesh to the scene
  scene.add(mesh5);
});
...
function TilesChanger4(obj = {}) {
  ...
  imageload2.forEach((texture1, ii) => {
    ...
    const cubeGeometry4 = new THREE.PlaneGeometry(210, 90);
...
async function openimage1(){
  ...
  temps = `<img  src="${filteredData[right4].fileUrl}"  width="90" height="90" alt="Snow" style=" z-index: 4; float:right; margin-right:20px; padding:0px; border: 4px solid white;" >`
...
if(index == 5 && middlechange == 1){
  temps = `<img  src="${filteredData[front4].fileUrl}"  width="90" height="90" alt="Snow" style=" z-index: 4; float:right; margin-right:20px; padding:0px; border: 4px solid white;" >`
...
for (const img of images) {
  img.addEventListener('click', function oClick() {
   ...
   function myURL() {
    ...
    TilesChanger4({ front4: parseInt(img.name) });
   }
