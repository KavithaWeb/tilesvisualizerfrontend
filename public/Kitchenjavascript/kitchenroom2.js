...
import { kitchen, kitchen1, kitchen2 } from '../Mainjavascript/constants.js';
...
let max = controls.maxDistance = 380;
...
let right = kitchen.right;
let left = kitchen.left;
let top = kitchen.top;
let bottom = kitchen.bottom;
let back = kitchen.back;
let front = kitchen.front;


let right1 = kitchen1.right1;
let left1 = kitchen1.left1;
let top1 = kitchen1.top1;
let bottom1 = kitchen1.bottom1;
let back1 = kitchen1.back1;
let front1 = kitchen1.front1;


let right2 = kitchen2.right2;
let left2 = kitchen2.left2;
let top2 = kitchen2.top2;
let bottom2 = kitchen2.bottom2;
let back2 = kitchen2.back2;
let front2 = kitchen2.front2;
...
function renderData(start) {
    ...
    const attachedData1 = { fileUrl: "https://jabez-tiles.s3.ap-south-1.amazonaws.com/PW03530_b.jpg", id:"9", tiles: "tilesimages" };
    const newData1 = attachedData1;
  
    const attachedData2 = { fileUrl: "https://jabez-tiles.s3.ap-south-1.amazonaws.com/PW03469_b.jpg", id:"10", tiles: "tilesimages" };
    ...
    const attachedData4 = { fileUrl: "https://jabez-tiles.s3.ap-south-1.amazonaws.com/PF01965_b.jpg", id:"12", tiles: "tilesimages" };
...
var defaultTexture2 = loader.load(`${'https://jabez-tiles.s3.ap-south-1.amazonaws.com/ceiling4.jpg'}?not-from-cache-please`);
  ...
  const defaultMaterial2 = new THREE.MeshStandardMaterial({ map: defaultTexture2, side: THREE.BackSide, roughness: 0.76, metalness: 0.9 });
...
function TilesChanger(obj = {}) {
  ...
  const cubeGeometry = new THREE.BoxGeometry(1460, 270, 1250);
...
const defaultMaterial22 = new THREE.MeshStandardMaterial({ map: defaultTexture22, side: THREE.BackSide, roughness: 0.76, metalness: 0.9 });
  ...
  // Default gap value
 let skyBox1;
 let repeatX2 = 1; // Default X repeat value
 let repeatY2 = 1; // Default Y repeat value
 let applyChessLayout2 = false; 
  ...
  const cubeGeometry1 = new THREE.BoxGeometry(1460, 296.66, 1250);

  // const edges1 = new THREE.EdgesGeometry( cubeGeometry1 );
  // const line1 = new THREE.LineSegments( edges1, new THREE.LineStandardMaterial( { color: 0x000000, linewidth: 5,
  //   linecap: 'round', 
  //   linejoin:  'round', side:BackSide }));
  // scene.add( line1 );
...
var defaultTexture222 = loader.load(`${'https://jabez-tiles.s3.ap-south-1.amazonaws.com/ceiling4.jpg'}?not-from-cache-please`);
...
// Default gap value
let skyBox2;
let repeatX3 = 1; // Default X repeat value
let repeatY3 = 1; // Default Y repeat value
let applyChessLayout3 = false; 
 ...
 // materialside.push(defaultMaterial3);
    ...
    imageload.forEach((texture, ii) => {
      ...
      const gapColor = new THREE.Color('lightgrey');
    material.onBeforeCompile = setMaterialShaderProperties(gapValue3, gapColor, material.onBeforeCompile);

    materialside.push(material);
    console.log(materialside);
  });

  function setMaterialShaderProperties(gapValue3, gapColor, _onBeforeCompile) {
    return shader => {
      shader.uniforms.gap = { value: gapValue3 };
      shader.uniforms.gapColor = { value: gapColor };
      shader.uniforms.applyChessLayout = { value: applyChessLayout3 };
  ...
  const cubeGeometry2 = new THREE.BoxGeometry(1460, 320, 1250);

  // const edges2 = new THREE.EdgesGeometry( cubeGeometry2 );
  // const line2 = new THREE.LineSegments( edges2, new THREE.LineBasicMaterial( { color: 0x000000, linewidth: 5,
  //   linecap: 'round', 
  //   linejoin:  'round', side:BackSide }));
  // scene.add( line2 );
  ...
  if (skyBox) {
    skyBox.material.forEach(material => {
      ...
      if (texture.id == 4) {
        ...
        texture.repeat.set(repeatX3, repeatY3);
        texture.needsUpdate = true; // Notify Three.js that the texture has been updated
      }
    });
...
const cubeGeometry3 = new THREE.BoxGeometry(1459, 887, 1249);
...
textureLoader1.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/Screenshot 2023-05-09 135833.png', function(texturei1) {
  // create a material with the texture
  var materiali1 = new THREE.MeshBasicMaterial({ map: texturei1 , transparent:true});
...
textureLoader2.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/Screenshot 2023-05-09 145255.png', function(texturei2) {
  // create a material with the texture
  var materiali2 = new THREE.MeshBasicMaterial({ map: texturei2 , transparent:true});
...
textureLoader6.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/Screenshot 2023-05-10 144538.png', function(texturei6) {
  // create a material with the texture
  var materiali6 = new THREE.MeshBasicMaterial({ map: texturei6 , transparent:true});
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/chicken_plate.glb', function (gltf5) {
  ...
  model5.position.set(100, -126, 380);
  scene1.add(model5);
  model5.traverse(function(child) {
    if (child.isMesh) {
      // child.castShadow = true;
