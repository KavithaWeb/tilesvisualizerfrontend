...
const canvas = document.querySelector('.kitchen6');
...
let max = controls.maxDistance = 580;
...
function TilesChanger(obj = {}) {
  ...
  imageload.forEach((texture, ii) => {
    ...
    const material = new THREE.MeshBasicMaterial({ side: THREE.BackSide, map: texture,  color: new THREE.Color(0.8, 0.8, 0.8) });
...
//   const cubeGeometry = new THREE.BoxGeometry(1500, 590, 1050);
...
// const cubeGeometry3 = new THREE.BoxGeometry(1499, 589, 1049);
...
var geometry = new THREE.PlaneGeometry(338, 540);

// create a texture loader
var textureLoader = new THREE.TextureLoader();

// load the texture
textureLoader.load('./kitchen/0c0166801828bc6b6d35792a7d738d3b.jpg', function(texturei) {
...
var geometry5 = new THREE.PlaneGeometry(290, 250);

// create a texture loader
var textureLoader5 = new THREE.TextureLoader();

// load the texture
textureLoader5.load('./kitchen/Screenshot 2023-08-04 114605.png', function(texturei5) {
  // create a material with the texture
  var materiali5 = new THREE.MeshBasicMaterial({ map: texturei5 });

  // create the mesh using the geometry and material
  var mesh5 = new THREE.Mesh(geometry5, materiali5);
  mesh5.position.set(800 ,150 ,-60);
...
gltfloader.load('./kitchen/modern_scandinavian_kitchen_island.glb', function (gltf6) {

    const model6 = gltf6.scene;
  
    model6.rotation.y = Math.PI / -2;
    model6.scale.set(200, 200, 200);
    model6.position.set(-20, -240, 190);
    scene1.add(model6);
    model6.traverse(function(child) {
      if (child.isMesh) {
        child.castShadow = true;
