...
const canvas = document.querySelector('.livingroom1');
...
let max = controls.maxDistance = 650;
...
console.log(texture.id);
  ...
  const cubeGeometry = new THREE.BoxGeometry(2000, 890, 1700);
...
const cubeGeometry2 = new THREE.BoxGeometry(1999, 888, 1699);
...
circle2.position.set(-995 ,-60 ,25);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/tv.glb', function (gltf6) {

  const model6 = gltf6.scene;

  model6.rotation.y = Math.PI / 1;
  model6.scale.set(2000, 2000, 2000);
  model6.position.set(140, -180, 430);
  scene1.add(model6);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/tv table 3.glb', function (gltf9) {

  const model9 = gltf9.scene;

  model9.rotation.y = Math.PI / 1;
  model9.scale.set(2500, 2500, 2500);
  model9.position.set(140, -360, 750);
  scene1.add(model9);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/photos.glb', function (gltf5) {
  ...
  model5.position.set(690, -220, 400);
  scene1.add(model5);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/jar.glb', function (gltf12) {

  const model12 = gltf12.scene;

  model12.rotation.y = Math.PI / -1;
  model12.scale.set(5000, 5000, 5000);
  model12.position.set(650, -400, -700);
  scene1.add(model12);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/tv table 2.glb', function (gltf13) {
  ...
  model13.position.set(-2100, -370, -60);
  scene1.add(model13);
  model13.traverse(function(child) {
    if (child.isMesh) {
      // child.castShadow = true;
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/wall plant 2.glb', function (gltf14) {
  ...
  model14.position.set(-300, 80, -930);
  scene1.add(model14);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/wall plant 2.glb', function (gltf15) {
  ...
  model15.position.set(-480, 180, -930);
  scene1.add(model15);
