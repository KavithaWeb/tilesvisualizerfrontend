...
// Now you can use the 'THREE' module in your code
...
const canvas = document.querySelector('.livingroom4');
...
let max = controls.maxDistance = 300;
...
function renderData(start) {
    const container = document.getElementById("tiles");
     ...
     filteredData = data.filter((item) => item.tiles === "tilesimages" && item.userid === `${userids}` );
...
console.log(texture.id);
  ...
  const cubeGeometry = new THREE.BoxGeometry(910, 500, 960);
...
const cubeGeometry2 = new THREE.BoxGeometry(909, 499, 959);
...
textureLoader7.load('./livingroom/Screenshot 2023-08-03 125437.png', function(texturei7) {
  ...
  mesh7.position.set(-450 ,100 ,200);
...
circle2.position.set(-450 ,100 ,-200);
...
let circleGeo6 = new THREE.PlaneGeometry(260,400);
let circleMat6 = new THREE.MeshBasicMaterial({map:tex});
let circle6 = new THREE.Mesh(circleGeo6, circleMat6);
circle6.position.set(449 ,15 ,-290);
...
gltfloader.load('./livingroom/sofa_combination.glb', function (gltf6) {

  const model6 = gltf6.scene;

  // model6.rotation.y = Math.PI / 1;
  model6.scale.set(2, 2, 2);
  model6.position.set(-0, -195, 150);
  scene1.add(model6);
  model6.traverse(function(child) {
    if (child.isMesh) {
      // child.castShadow = true;
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/photos.glb', function (gltf5) {
  ...
  model5.scale.set(500, 500, 500);
  model5.position.set(270, -45, 420);
  scene1.add(model5);
...
// gltfloader.load('./livingroom/shapespark-example-room.glb', function (gltf6) {

//     const model6 = gltf6.scene;
  
//     model6.rotation.y = Math.PI / 1;
//     model6.scale.set(110, 110, 110);
//     model6.position.set(-200, -150, -255);
//     scene1.add(model6);
//     model6.traverse(function(child) {
//       if (child.isMesh) {
//         // child.castShadow = true;
...
gltfloader.load('./livingroom/tv_set_i.glb', function (gltf9) {

  const model9 = gltf9.scene;

  // model9.rotation.y = Math.PI / 1;
  model9.scale.set(150, 150, 150);
  model9.position.set(-70, -120, -490);
  scene1.add(model9);
