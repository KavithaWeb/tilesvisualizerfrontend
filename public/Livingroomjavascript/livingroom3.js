...
const canvas = document.querySelector('.livingroom3');
...
camera.position.set(520, 0, 0);
// camera.lookAt(0, 0, 0);
scene.add(camera);

const camera1 = new THREE.PerspectiveCamera(fov, aspect, near, far);
camera1.position.set(520, 0, 0);
// camera.lookAt(0, 0, 0);
...
let max = controls.maxDistance = 520;
...
console.log(texture.id);
  ...
  const cubeGeometry = new THREE.BoxGeometry(1130, 580, 1350);
...
const cubeGeometry2 = new THREE.BoxGeometry(1129, 579, 1349);
...
var tex = textureLoader8.load('./livingroom/Screenshot 2023-08-03 143333.png');
let circleGeo2 = new THREE.PlaneGeometry(550,620);
let circleMat2 = new THREE.MeshBasicMaterial({map:tex});
let circle2 = new THREE.Mesh(circleGeo2, circleMat2);
circle2.position.set(-562 ,80 ,-230);
...
gltfloader.load('./livingroom/model (5).glb', function (gltf6) {

    const model6 = gltf6.scene;
  
    model6.rotation.y = Math.PI / 1;
    model6.scale.set(230, 230, 230);
    model6.position.set(180, -200, -100);
    scene1.add(model6);
    model6.traverse(function(child) {
      if (child.isMesh) {
        // child.castShadow = true;
...
//   model9.scale.set(2000, 2400, 2300);
//   model9.position.set(140, -360, 620);
//   scene1.add(model9);
