...
import { BackSide, DoubleSide } from '/three/build/three.module.js';
...
const light5 = new THREE.SpotLight(0xffffff, 0.3);
...
//   const cubeGeometry = new THREE.BoxGeometry(1860, 1000, 1720);
...
function TilesChanger(obj = {}) {
  ...
  const cubeGeometry = new THREE.BoxGeometry(1225, 756, 1990);
...
function TilesChanger2(obj = {}) {
  ...
  const cubeGeometry2 = new THREE.BoxGeometry(1224, 755, 1989);
...
var geometry7 = new THREE.PlaneGeometry(500, 300);

// create a texture loader
var textureLoader7 = new THREE.TextureLoader();

// load the texture
textureLoader7.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/Screenshot 2023-08-10 111820.png', function (texturei7) {
  // create a material with the texture
  var materiali7 = new THREE.MeshBasicMaterial({ map: texturei7 });

  // create the mesh using the geometry and material
  var mesh7 = new THREE.Mesh(geometry7, materiali7);
  mesh7.position.set(-600, 150, 630);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/model (14).glb', function (gltf6) {

  const model6 = gltf6.scene;

  model6.rotation.y = Math.PI / 1;
  model6.scale.set(220, 220, 220);
  model6.position.set(28, -300, -30);
  scene1.add(model6);
  model6.traverse(function (child) {
    if (child.isMesh) {
      // child.castShadow = true;
...
// gltfloader.load('./livingroom/living_room_daytime_-_custom_home_environment.glb', function (gltf9) {

//   const model9 = gltf9.scene;

//   model9.rotation.y = Math.PI / 2;
//   model9.scale.set(400, 400, 400);
//   model9.position.set(90, -120, 420);
//   scene1.add(model9);
...
// gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/sofa table2.glb', function (gltf8) {

//   const model8 = gltf8.scene;

//   model8.rotation.y = Math.PI / 1;
//   model8.scale.set(3000, 3000, 3000);
//   model8.position.set(200, -350, 900);
//   scene1.add(model8);
...
// gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/scene (5).glb', function (gltf7) {

//   const model7 = gltf7.scene;

//   model7.rotation.y = Math.PI / 1;
//   model7.scale.set(3100, 2800, 2000);
//   model7.position.set(250, -350, 630);
//   scene1.add(model7);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/photos.glb', function (gltf5) {

  const model5 = gltf5.scene;

  model5.rotation.y = Math.PI / -1;
  model5.scale.set(800, 800, 800);
  model5.position.set(325, -100, 820);
  scene1.add(model5);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/tv_sony_bravia_kdl-40re353 (1).glb', function (gltf16) {

  const model16 = gltf16.scene;

  model16.rotation.y = Math.PI / -1.5;
  model16.scale.set(200, 200, 200);
  model16.position.set(0, 180, 990);
  scene1.add(model16);
