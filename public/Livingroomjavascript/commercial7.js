...
const canvas = document.querySelector('.commercial7');
...
let max = controls.maxDistance = 50;
controls.enableDamping = true;
controls.dampingFactor = 0.2;

// setTimeout(rotate1, 1-0);
...
// controls1.maxDistance = 3000;

// controls1.enableDamping = true;
// controls1.dampingFactor = 0.2;


// setTimeout(rotate, 300000);
...
const light2 = new THREE.SpotLight(0xffffff,1.6);
...
const light3 = new THREE.SpotLight(0xffffff,1.6);
...
const light4 = new THREE.SpotLight(0xffffff, 1.6);
...
const light5 = new THREE.SpotLight(0xffffff, 1.6);
 light5.position.set(-30, -20, -1400);
 light5.target.position.set(-100, 110, -350);


 scene1.add( light5.target );
 scene1.add(light5);
// const spotLightHelper4 = new THREE.SpotLightHelper( light5 );
// scene1.add( spotLightHelper4 );
...
// all texture
let frontTexture = loader1.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/front.jpg');
let backTexture = loader1.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/back.jpg');
let topTexture = loader1.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/top.jpg');
let bottomTexture = loader1.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/bottom.jpg');
let rightTexture = loader1.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/left.jpg');
let leftTexture = loader1.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/right.jpg');
...
// making cube
const cubeGeometry4 = new THREE.BoxGeometry(1000, 1000, 1000);
const skyBox4 = new THREE.Mesh(cubeGeometry4, textureArray);
scene.add(skyBox4);
...
console.log(texture.id);
    ...
    const material = new THREE.MeshBasicMaterial({ map: texture, side: THREE.BackSide, roughness: 0.76, metalness: 0.9 });
  ...
  const cubeGeometry = new THREE.BoxGeometry(300, 350, 380);
...
// // Adjust vertices to create deformation
// for (let i = 0; i < cubeGeometry.vertices.length; i++) {
//     const vertex = cubeGeometry.vertices[i];
//     vertex.x *= 0.5; // Scale x-coordinate
//     vertex.y *= 2.0; // Scale y-coordinate
//     vertex.z *= 0.5; // Scale z-coordinate
// }
...
// const cubeGeometry2 = new THREE.BoxGeometry(949, 549, 789);
...
// var tex = textureLoader9.load('./livingroom/Screenshot 2023-08-03 130657.png');
// let circleGeo6 = new THREE.PlaneGeometry(260,450);
// let circleMat6 = new THREE.MeshBasicMaterial({map:tex});
// let circle6 = new THREE.Mesh(circleGeo6, circleMat6);
// circle6.position.set(-449 ,10 ,0);

// circle6.rotation.y = Math.PI / 2;
// scene.add(circle6);
...
// gltfloader.load('./livingroom/terrace_houses_at_36_courtenay_cres.glb', function (gltf6) {

//     const model6 = gltf6.scene;
  
//     model6.rotation.y = Math.PI / 1;
//     model6.scale.set(20, 20, 20);
//     model6.position.set(-1800, -129, 280);
//     scene1.add(model6);
//     model6.traverse(function(child) {
//       if (child.isMesh) {
//         // child.castShadow = true;
...
//   gltfloader.load('./livingroom/2_floor_exterior_design.glb', function (gltf6) {

//     const model6 = gltf6.scene;
  
//     model6.rotation.y = Math.PI / 1;
//     model6.scale.set(30, 30, 30);
//     model6.position.set(25, -130, 0);
//     scene1.add(model6);
//     model6.traverse(function(child) {
//       if (child.isMesh) {
//         // child.castShadow = true;
...
//   });
  ...
  gltfloader.load('./livingroom/model (9).glb', function (gltf6) {

    const model6 = gltf6.scene;
  
    model6.rotation.y = Math.PI / 1.7;
    model6.scale.set(30, 30, 30);
    model6.position.set(-150, -35, 195);
    scene1.add(model6);
    model6.traverse(function(child) {
      if (child.isMesh) {
        // child.castShadow = true;
