...
const canvas = document.querySelector('.commercial4');
...
let max = controls.maxDistance = 400;
...
// const light4 = new THREE.SpotLight(0xffffff, 0.6);
...
console.log(texture.id);
  ...
  const cubeGeometry = new THREE.BoxGeometry(950, 550, 790);
...
var tex = textureLoader8.load('./livingroom/Screenshot 2023-08-09 125935.png');
let circleGeo2 = new THREE.PlaneGeometry(300,200);
let circleMat2 = new THREE.MeshBasicMaterial({map:tex});
let circle2 = new THREE.Mesh(circleGeo2, circleMat2);
circle2.position.set(452 ,80 ,0);
...
var tex = textureLoader9.load('./livingroom/Screenshot 2023-08-09 125341.png');
let circleGeo6 = new THREE.PlaneGeometry(790,550);
let circleMat6 = new THREE.MeshBasicMaterial({map:tex});
let circle6 = new THREE.Mesh(circleGeo6, circleMat6);
circle6.position.set(-465,50 ,0);
...
// gltfloader.load('./livingroom/5_lots_terrace_houses.glb', function (gltf6) {

//   const model6 = gltf6.scene;

//   model6.rotation.y = Math.PI / 1;
//   model6.scale.set(180, 180, 180);
//   model6.position.set(60, 50, 0);
//   scene1.add(model6);
//   model6.traverse(function(child) {
//     if (child.isMesh) {
//       // child.castShadow = true;
...
gltfloader.load('./livingroom/modern_office.glb', function (gltf6) {

    const model6 = gltf6.scene;
  
    model6.rotation.y = Math.PI / 1;
    model6.scale.set(180, 180, 180);
    model6.position.set(60, 90, 0);
    scene1.add(model6);
    model6.traverse(function(child) {
      if (child.isMesh) {
        // child.castShadow = true;
