...
const canvas = document.querySelector('.bedroom2');
...
const light4 = new THREE.SpotLight(0xffffff, 0.5);
 light4.position.set(-30, -20, 1350);
...
function TilesChanger(obj = {}) {
 ...
 // materialside.push(defaultMaterial3);
  ...
  const cubeGeometry = new THREE.BoxGeometry(1190, 1070, 1730);
...
const cubeGeometry2 = new THREE.BoxGeometry(1190, 1070, 1730);
...
// circle2.position.set(698 ,-52 ,55);
...
var geometry5 = new THREE.PlaneGeometry(800, 700);

// create a texture loader
var textureLoader5 = new THREE.TextureLoader();

// // load the texture
textureLoader5.load('./bedroom/depositphotos_279177254-stock-photo-view-window-silhouettes-window-curtain.jpg', function(texturei5) {
  // create a material with the texture
  var materiali5 = new THREE.MeshBasicMaterial({ map: texturei5 });

  // create the mesh using the geometry and material
  var mesh5 = new THREE.Mesh(geometry5, materiali5);
  mesh5.position.set(50 ,280 ,-862);
...
gltfloader.load('./bedroom/bedroom_test.glb', function (gltf6) {

  const model6 = gltf6.scene;

  // model6.rotation.y = Math.PI / -1;
  model6.scale.set(4, 4, 4);
  model6.position.set(100, -450, -560);
  scene1.add(model6);
...
gltfloader.load('./bedroom/tv_sony_bravia_kdl-40re353 (1).glb', function (gltf16) {

  const model16 = gltf16.scene;

  model16.rotation.y = Math.PI / 0.55;
  model16.scale.set(200, 200, 200);
  model16.position.set(580, 265, -210);
  scene1.add(model16);
