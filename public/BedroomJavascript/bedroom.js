...
const canvas = document.querySelector('.bedroom1');
...
const light3 = new THREE.SpotLight(0xffffff,0.3);
 light3.position.set(-1300, -80, -110);
...
function TilesChanger(obj = {}) {
 ...
 // materialside.push(defaultMaterial3);
  ...
  const cubeGeometry = new THREE.BoxGeometry(1800, 1000, 1850);
...
const cubeGeometry2 = new THREE.BoxGeometry(1800, 1000, 1850);
...
var tex = textureLoader8.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/Screenshot 2023-05-30 102152.png');
let circleGeo2 = new THREE.PlaneGeometry(340,730);
let circleMat2 = new THREE.MeshBasicMaterial({map:tex});
let circle2 = new THREE.Mesh(circleGeo2, circleMat2);
circle2.position.set(898 ,-52 ,55);

circle2.rotation.y = Math.PI / -2;
scene.add(circle2);

var textureLoader9 = new THREE.TextureLoader();
var tex1 = textureLoader9.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/Screenshot 2023-05-30 111603.png');
let circleGeo3 = new THREE.PlaneGeometry(440,260);
let circleMat3 = new THREE.MeshBasicMaterial({map:tex1});
let circle3 = new THREE.Mesh(circleGeo3, circleMat3);
circle3.position.set(-80 ,210 ,-920);

// circle3.rotation.y = Math.PI / 1;
scene.add(circle3);

var geometry5 = new THREE.PlaneGeometry(800, 550);
...
circle1.position.set(-640, -35, -845);
...
circle6.position.set(450, -35, -845);
...
// // load the texture
// textureLoader7.load('kitchen/Screenshot 2023-05-08 140207.png', function(texturei7) {
//   // create a material with the texture
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/tv.glb', function (gltf6) {
  ...
  model6.position.set(-150, -170, -350);
  scene1.add(model6);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/chairbed.glb', function (gltf7) {
  ...
  model7.position.set(150, -260, 600);
  scene1.add(model7);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/curtain.glb', function (gltf5) {
  ...
  model5.position.set(-880, -350, 160);
  scene1.add(model5);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/table 5.glb', function (gltf12) {
  ...
  model12.position.set(785, -410, -550);
  scene1.add(model12);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/table brn 2.glb', function (gltf13) {
  ...
  model13.position.set(-530, -350, 0);
  scene1.add(model13);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/lamp 3.glb', function (gltf14) {
  ...
  model14.position.set(150, -400, -820);
  scene1.add(model14);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/lamp 3.glb', function (gltf15) {
  ...
  model15.position.set(-950, -400, -820);
  scene1.add(model15);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/photo frame 1.glb', function (gltf16) {
  ...
  model16.scale.set(1100, 1000, 1000);
  model16.position.set(600, 100, 1050);
  scene1.add(model16);
...
gltfloader.load('https://jabez-tiles.s3.ap-south-1.amazonaws.com/photo frame 2.glb', function (gltf17) {
  ...
  model17.position.set(600, 100, 1150);
  scene1.add(model17);
