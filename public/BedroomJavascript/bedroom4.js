...
const canvas = document.querySelector('.bedroom4');
...
camera.position.set(0, 0, 1080);
// camera.lookAt(0, 0, 0);
scene.add(camera);

const camera1 = new THREE.PerspectiveCamera(fov, aspect, near, far);
camera1.position.set(0, 0, 1080);
// camera.lookAt(0, 0, 0);
...
let controls = new OrbitControls(camera, renderer.domElement);
 ...
 controls.maxDistance = 1080;
controls.enableDamping = true;
controls.dampingFactor = 0.2;

// setTimeout(rotate, 11080);
...
const light3 = new THREE.SpotLight(0xffffff,0.2);
 light3.position.set(-1700, -80, -110);
...
function TilesChanger(obj = {}) {
 ...
 // materialside.push(defaultMaterial3);
  ...
  const cubeGeometry = new THREE.BoxGeometry(2315, 2000, 3800);
...
const cubeGeometry2 = new THREE.BoxGeometry(2315, 2000, 3800);
...
//   const cubeGeometry = new THREE.BoxGeometry(2050, 1330, 2445);
...
// const cubeGeometry2 = new THREE.BoxGeometry(2049, 1329, 2444);
...
var tex = textureLoader8.load('./bedroom/3f44ccb1e05dd3a3408ba79b840fa2ec.jpg');
let circleGeo2 = new THREE.PlaneGeometry(600,1200);
let circleMat2 = new THREE.MeshBasicMaterial({map:tex});
let circle2 = new THREE.Mesh(circleGeo2, circleMat2);
circle2.position.set(-1108 ,-185 ,1000);
...
gltfloader.load('./bedroom/bedroom_interior.glb', function (gltf6) {

  const model6 = gltf6.scene;

  // model6.rotation.y = Math.PI / -1;
  model6.scale.set(1500, 1500, 1500);
  model6.position.set(120, -800, 0);
  scene1.add(model6);
...
//   model13.rotation.y = Math.PI / 2;
//   model13.scale.set(1000, 1000, 1000);
//   model13.position.set(-0, 0, -500);
//   scene1.add(model13);
//   model13.traverse(function(child) {
//     if (child.isMesh) {
//       // child.castShadow = true;
...
//   model17.rotation.y = Math.PI / 1;
  model17.scale.set(2000, 2000, 2000);
  model17.position.set(900, 500, -1300);
  scene1.add(model17);
